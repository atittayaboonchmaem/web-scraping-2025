...
#    np.random.randn(1000, 2) / [50, 50] + [19.19203, 99.87883],
#    columns=['lat', 'lon'])
...
#add_slider = st.sidebar.slider( #sidebarกำหนดที่อยู่ว่าอยู่ส่วนไหนของหน้าเว็บ
#    'Select a range of values',
#    0.0, 100.0, (25.0, 75.0)
#)

#import streamlit as st
#กำหนดว่าให้อยู่ฝั่งซ้ายของหน้าเว็บ
